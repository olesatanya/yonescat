					...
					<div className="container-sm">
						<div className="row">
							<div className="col-12 ">
								<h3 className='text-stroke h2 title' style={{ zIndex: 0, WebkitTextStroke: '1px rgba(255,255,255,0.1)' }}>{T("menu.faq")}</h3>
								<h1 className='text-light h1 title' style={{ zIndex: 2 }}>{T("menu.faq")}</h1>
							</div>
						</div>
						<div className="row m0 pb3">
							<div className="col-12" style={{ fontSize: '24px' }}>
								...
								<Link to="/"><label className='text-primary'> {T("menu.faq")} </label></Link>
							</div>
						</div>
					</div>
				</div>
						...
						<div className="col-xl-3 col-md-12">
							<ScrollAnimation animateIn="slideInLeft" animateOut="fadeOutUp">
								<div className='type-pan'>
									<div className={`faq-list-item ${state.type === 1 ? 'active' : ''}`} onClick={() => { updateStatus({ type: 1 }) }}>{T("faq.item.title1")}	</div>
									<div className={`faq-list-item ${state.type === 2 ? 'active' : ''}`} onClick={() => { updateStatus({ type: 2 }) }}>{T("faq.item.title2")}	</div>
									<div className={`faq-list-item ${state.type === 3 ? 'active' : ''}`} onClick={() => { updateStatus({ type: 3 }) }}>{T("faq.item.title3")}	</div>
									<div className={`faq-list-item ${state.type === 4 ? 'active' : ''}`} onClick={() => { updateStatus({ type: 4 }) }}>{T("faq.item.title4")}	</div>
									<div className={`faq-list-item ${state.type === 5 ? 'active' : ''}`} onClick={() => { updateStatus({ type: 5 }) }}>{T("faq.item.title5")}	</div>
								</div>
							</ScrollAnimation>
						</div>
							...
							<div className="desc-pan">
								<ScrollAnimation animateIn="fadeInUp" animateOut="fadeOutUp">
									<div className="faq-title">
										{T(`faq.type${state.type}.item1.title`)}
									</div>
									<div className="faq-desc">
										{T(`faq.type${state.type}.item1.desc`)}
									</div>
								</ScrollAnimation>
								<ScrollAnimation animateIn="fadeInUp" animateOut="fadeOutUp">
									<div className="faq-title">
										{T(`faq.type${state.type}.item2.title`)}
									</div>
									<div className="faq-desc">
										{T(`faq.type${state.type}.item2.desc`)}
									</div>
								</ScrollAnimation>
								<ScrollAnimation animateIn="fadeInUp" animateOut="fadeOutUp">
									<div className="faq-title">
										{T(`faq.type${state.type}.item3.title`)}
									</div>
									<div className="faq-desc">
										{T(`faq.type${state.type}.item3.desc`)}
									</div>
								</ScrollAnimation>
							</div>
						</div>
